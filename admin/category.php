  ...
  <?php
    ...
    ?>
     ...
     <td><?php echo $data['CategoryCode']??''; ?></td>
      ...
      <td><a href="update.php?id=<?php echo $data["id"]; ?>"><button>Update </a></button>
      <a href="delete.php?id=<?php echo $data["id"]; ?>"><button style="background-color:red"> Delete </a></button>
      </td>    
       <?php
      $sn++;}}else{ ?>
      <tr>
